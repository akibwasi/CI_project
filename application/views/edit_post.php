...
=======
	echo"<p>You are logged in as ".$username." &bull; <a class='cat_links1' href='member_login/logout'>Logout</a>";	
>>>>>>> parent of 1cc8bac... CI_project1
...
=======
  <textarea name="post_content" id="z" rows="5" cols="76"><?php echo"$post_content"; ?></textarea><div class="z2"> </div>
>>>>>>> parent of 1cc8bac... CI_project1
  <br /><br />
...
=======
	username: <input class='tt' type='text' name='username' id='p'/>&nbsp;
	password: <input class='ttt' type='password' name='password' id='q'/>&nbsp;
	<input type='submit' name='submit' value='Log In'/>
	<div class='d1'> </div> </form>
	</br><div class='d5'> If you don't have an account already please <a href='register'>Register </a></div> 	
>>>>>>> parent of 1cc8bac... CI_project1
	";
